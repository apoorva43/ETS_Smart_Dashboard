...
![Percentile Score Profile comparing Canada and the United States against the OECD average. The visualization maps the full P10–P90 spread, revealing that the bottom 10% of students often experience distinct score shifts invisible in average-only reporting.](../../data/images/fig1_math_dist.png){#fig-percentile-profile}
