...
Research demonstrates that this mean-centric approach causes audiences to attribute performance gaps to intrinsic group traits rather than systemic factors [@holder_dispersion_2022], with direct consequences for how education departments allocate resources. When data is presented without distributional context, the students most in need of support are the most likely to be mischaracterized and underserved. Aligning with ETS's mission regarding fairness and equity in assessment [@ets_mission], this project demonstrates that shifting the paradigm of data presentation directly leads to more equitable policy decisions.
